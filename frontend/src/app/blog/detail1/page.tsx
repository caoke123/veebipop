                    ...
                    <div className="blog-content flex items-center justify-center">
                        <div className="main md:w-5/6 w-full">
                                ...
                                <div className="left flex items-center gap-3 flex-wrap">
                                    ...
                                    <div className="list flex items-center gap-3 flex-wrap">
                                        {['fashion', 'yoga', 'organic'].map((cat) => {
                                            ...
                                            return (
                                                <Link key={cat} href={href} className={`tags bg-surface py-1.5 px-4 rounded-full text-button-uppercase cursor-pointer duration-300 hover:bg-black hover:text-white`}>
                                                    {cat}
                                                </Link>
                                            )
                                        })}
                            ...
                            <div className="next-pre flex items-center justify-between md:mt-8 mt-5 py-6 border-y border-line">
                                {blogId === '1' ? (
                                    <>
                                        <Link href={buildHref('/blog/detail1', searchParams, { set: { id: String(blogData.length) } })} className="left cursor-pointer">
                                    ...
                                    <>
                                        <Link href={buildHref('/blog/detail1', searchParams, { set: { id: String(blogData[Number(blogId) - 2].id) } })} className="left cursor-pointer">
                                            <div className="text-button-uppercase text-secondary2">Previous</div>
                                ...
                                {Number(blogId) === blogData.length ? (
                                    <>
                                        <Link href={buildHref('/blog/detail1', searchParams, { set: { id: '1' } })} className="right text-right cursor-pointer">
                                    ...
                                    <>
                                        <Link href={buildHref('/blog/detail1', searchParams, { set: { id: String(blogData[Number(blogId)].id) } })} className="right text-right cursor-pointer">
                                            <div className="text-button-uppercase text-secondary2">Next</div>
